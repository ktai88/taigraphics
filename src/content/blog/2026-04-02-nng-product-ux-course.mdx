...
<ContentSection size="800">
  ...
  <p class="card-kicker blog-meta-line"><span class="blog-tag blog-tag--training">Training &amp; Certification</span> <span class="text-[color:var(--color-text-label)]">·</span> <img src="/heroicons/clock.svg" class="inline w-4 h-4 align-middle" alt="Leestijd" /> 8 minuten leestijd - 2 april 2026</p>
